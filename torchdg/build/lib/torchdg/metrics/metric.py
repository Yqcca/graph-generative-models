...
from torchdg import utils
from torchdg.layers import functional
from torchdg.core import Registry as R
from torchdg.metrics.rdkit import sascorer
...
def AMLODIPINE_MPO(pred):
    ...
    for mol in pred:
        with utils.no_rdkit_log():
            score = oracle.amlodipine_mpo(mol.to_molecule())
